...
var diff_order_stats = [
  { order_status: 'Processing', orderId: 1 }, 
    { order_status: 'Completed', orderId: 2 }, 
 ];
  ...
  },
  {
    ...
    edit: {  
      params: {  
        ...
        dataSource: new DataManager(diff_order_stats),
        fields: { text: "order_status", value: "order_status" },
        query: new Query()
      }  
    }
  },
